...
function AboutPage() {
  ...
  const cityImage =
    "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1c/ae/5d/da/caption.jpg?w=2400&h=1000&s=1";
        ...
        >
          ...
          <div className=" flex space-x-3">
            ...
            <div className="w-[60%]">
              <img
                src={cityImage}
                className="rounded-md shadow-md shadow-black/30"
                alt=""
              ></img>
            </div>

            {/*weather*/}
            <WeatherBox degrees="30" status="sunny" />
          </div>
        </div>
      </div>
    </div>
